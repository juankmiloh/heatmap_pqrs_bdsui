                ...
                success: function(data){
                        ...
                        $.each(data, function(i, item) {
                                $tr = $('<tr>').append(                                        
                                        ...
                                        $('<td>').html('<a href="javascript:visualizar(\'opcionBtnCausas\',JSON.stringify([{\'cod_empresa\':'+cod_empresa+',\'cod_causa\':\''+item.cod_causa+'\'}]))" style="color: black;"><i class="fas fa-external-link-alt"></i></a>')    
                                ).appendTo('#table_pqrs_causas tbody');
                        });
                        $('#table_pqrs_causas').show();
                        $("#table_pqrs_causas").tableExport({                
