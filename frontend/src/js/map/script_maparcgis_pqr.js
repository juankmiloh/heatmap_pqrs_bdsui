...
function visualizar(opcion, datos) {
  $( "caption" ).remove(); // SE ELIMINA EL CAPTION DONDE SE CARGA EL EXPORT DEL EXCEL
            ...
            if (item.servicio != "") {
                 ...
                 ) 
              {
                $tr = $('<tr>').append(
                  ...
                  $('<td>').html('<a href="javascript:visualizar(\'opcionBtnEmpresas\',JSON.stringify([{\'cod_empresa\':'+item.cod_empresa+',\'servicio\':\''+item.servicio.toLowerCase()+'\',\'cod_causa\':\''+cod_causa+'\'}]))" style="color: black;"><i class="fas fa-external-link-alt"></i></a>')
